...
### Configuration
To be able to use this CIF connector you will need to provid some Saleor configurations to connect to your Saleor endpoint.
...
```
{
  "SAL_CLIENTSECRET": "<CLIENT_SECRET>",
  "SAL_CLIENTID": "<CLIENT_ID>",
  "SAL_OAUTH_PATH": "/authorizationserver/oauth/token",
  "SAL_API_HOST": "commerceio.saleor.cloud",
  "SAL_API_BASE_PATH": "/occ/v2/",
  "SAL_BASESITEID": "electronics",
  "SAL_PROTOCOL": "https",
  "SAL_SECURE_BASE_MEDIA_URL": "https://commerceio.saleor.cloud/storefront"
}
```
